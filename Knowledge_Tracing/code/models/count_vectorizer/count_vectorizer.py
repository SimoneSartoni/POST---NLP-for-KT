...
class count_vectorizer(base_model):
    ...
    def load_similarity_matrix(self, dataset_name):
        ...
        self.similarity_matrix = sps.load_npz(os.path.join(data_folder, dataset_name + '/count_vectorizer_similarity_' + str(self.shrink) + '_' + str(self.topK) + '_' + str(self.normalize) + '.npz'))
    ...
    def save_similarity_matrix(self, dataset_name):
        ...
        sps.save_npz(os.path.join(data_folder,
                                  dataset_name+'/count_vectorizer_similarity_' + str(self.shrink) + '_' + str(self.topK) + '_' + str(self.normalize) + '.npz'),
