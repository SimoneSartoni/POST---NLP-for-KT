...
def extract_pro_pro_sim(pro_num, pro_skill_csc, pro_skill_csr, data_folder='./'):
...
def extract_skill_skill_sim(skill_num, pro_skill_csc, pro_skill_csr, data_folder='./'):
...
def execute(data_folder='./'):
    ...
    extract_pro_pro_sim(pro_num, pro_skill_csc, pro_skill_csr, data_folder='./')
    extract_skill_skill_sim(skill_num, pro_skill_csc, pro_skill_csr, data_folder='./')
