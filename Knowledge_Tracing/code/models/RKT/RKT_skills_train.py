...
def train(train_data, val_data, pro_num, corr_data, timestamp, timespan, models, optimizers, logger, saver, num_epochs,
    ...
    for epoch in range(num_epochs):
        ...
        for data, labels in training_generator:
            item_inputs, skill_inputs, label_inputs, item_ids, skill_ids, timestamp = data
            ...
            for i in range(len(models)):
                ...
                outputs, weights = model(item_inputs, skill_inputs, label_inputs, item_ids, skill_ids, rel, time)
