...
def create_dataset(generator, encoding_depth, nb_skills, shuffle=True, batch_size=1024):
    input_types = {"skill": tf.float32, "target_skill": tf.float32}
    output_types = {"target_label": tf.float32}

    input_shapes = {"skill": [None], "target_skill": [None]}
...
def load_dataset(batch_size=32, shuffle=True,
    ...
    inputs = {"question_id": False, "text_id": False, "skill": True,
              "label": True, "r_elapsed_time": False, 'text_encoding': True, "target_id": False,
              "target_text_id": False, "target_skill": True, 'target_label': False, 'target_text_encoding': True}
