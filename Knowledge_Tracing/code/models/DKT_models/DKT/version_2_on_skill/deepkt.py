...
from Knowledge_Tracing.code.models.DKT_models.DKT.version_2_on_skill.data_utils import *
...
class CustomDKTLayer(tf.keras.layers.Layer):
    def __init__(self, nb_features, hidden_units=100, dropout_rate=0.2, **kwargs):
        ...
        self.output_feature_layer = tf.keras.layers.TimeDistributed(self.dense_feature_layer,
                                                                    name='intermediate_feature')

        self.dense_feature_layer_2 = tf.keras.layers.Dense(nb_features, activation='sigmoid')
        self.output_feature_layer_2 = tf.keras.layers.TimeDistributed(self.dense_feature_layer_2,
                                                                      name='outputs_feature')
    ...
    def call(self, input_feature, target_feature):
        ...
        print(lstm)
        intermediate_feature = self.output_feature_layer(lstm)
        output_feature = self.output_feature_layer_2(intermediate_feature)
