...
class count_vect_plus_skill_doubled_DKT(Model):
    ...
    def compile(self, optimizer, metrics=None):
        ...
        super(count_vect_plus_skill_doubled_DKT, self).compile(
              loss=custom_loss,
              optimizer=optimizer,
              metrics=metrics,
    ...
    def fit(self,
        ...
        Raises:
            ...
            ValueError: In case of mismatch between the provided input data
                and what the model expects.
        """
        return super(count_vect_plus_skill_doubled_DKT, self).fit(x=dataset,
                                                                  epochs=epochs,
                                                                  verbose=verbose,
                                                                  callbacks=callbacks,
    ...
    def custom_evaluate(self,
        ...
        """
        return super(count_vect_plus_skill_doubled_DKT, self).evaluate(dataset,
                                                                       verbose=verbose,
                                                                       steps=steps,
                                                                       callbacks=callbacks)
