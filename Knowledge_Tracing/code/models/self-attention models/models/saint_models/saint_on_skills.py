...
class SAINT_on_skills(nn.Module):
    ...
    def forward(self, inputs, decoder_targets):
        ...
        in_skill, in_response = encoder_inputs['skill'], decoder_inputs['input_label']

        in_encoder, in_decoder = self.embedding(in_skill, in_response)
...
class EmbeddingBlock(nn.Module):
    ...
    def forward(self, input_skill, input_r):
