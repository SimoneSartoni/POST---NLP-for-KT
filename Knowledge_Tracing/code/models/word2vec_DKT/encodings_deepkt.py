...
class encodings_DKTModel(Model):
    ...
    def __init__(self, nb_encodings, hidden_units=100, dropout_rate=0.2):
        ...
        super(encodings_DKTModel, self).__init__(inputs=[input_encoding_correct, input_encoding_wrong],
    ...
    def compile(self, optimizer, metrics=None):
        ...
        super(encodings_DKTModel, self).compile(
            loss=custom_loss,
            optimizer=optimizer,
            metrics=metrics,
    ...
    def fit(self,
        ...
        Raises:
            ...
            ValueError: In case of mismatch between the provided input data
                and what the model expects.
        """
        return super(encodings_DKTModel, self).fit(x=dataset,
                                                   epochs=epochs,
                                                   verbose=verbose,
                                                   callbacks=callbacks,
    ...
    def custom_evaluate(self,
        ...
        """
        return super(encodings_DKTModel, self).evaluate(dataset,
                                                  verbose=verbose,
                                                  steps=steps,
                                                  callbacks=callbacks)
