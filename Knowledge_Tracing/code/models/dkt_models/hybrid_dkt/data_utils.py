...
def load_dataset(batch_size=32, shuffle=True,
    ...
    if 'pretrained_distilbert' in nlp_kwargs:
        ...
        config_path, model_filepath, fit_on_custom, fit_on_nli, text_column = pretrained_distilbert_args['config_path']\
            , pretrained_distilbert_args['model_filepath'], pretrained_distilbert_args['fit_on_custom'], \
            pretrained_distilbert_args['fit_on_nli'], pretrained_distilbert_args['text_column']
