...
from code.actually_unuused.Similarity.Compute_Similarity_Python import Compute_Similarity_Python
from code.actually_unuused.Similarity.Compute_Similarity_Euclidean import Compute_Similarity_Euclidean
        ...
        if similarity == "euclidean":
            ...
            if use_implementation == "cython":
                ...
                try:
                    ...
                    print("Unable to load_preprocessed Cython Compute_Similarity, reverting to Python")
...
#
#
#                 from Base.Similarity.Cython.cosine data_processing cosine_similarity
#                 from Base.Similarity.Cython.dice data_processing dice_similarity
#                 from Base.Similarity.Cython.tversky data_processing tversky_similarity
#                 from Base.Similarity.Cython.jaccard data_processing tanimoto_similarity, jaccard_similarity
#
#
#
#             except ImportError:
#                 print("Unable to load_preprocessed Cython Cosine_Similarity, reverting to Python")
#                 self.compute_similarity_object = Compute_Similarity_Python(dataMatrix, **args)
#
#
#         elif use_implementation == "python":
