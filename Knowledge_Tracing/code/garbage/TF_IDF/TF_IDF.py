...
class TF_IDF(base_model):
    ...
    def fit(self, interacted_and_text_problems, problem_id_to_index, texts):
        ...
        sps.save_npz(os.path.join(data_folder, '../../models/pro_words.npz'), tfidf_vectorizer_vectors)
    ...
    def get_serializable_params(self):
        return {"min_df": self.min_df, "max_df": self.max_df, "name": self.name, "topK": self.topK, "shrink": self.shrink, "normalize": self.normalize,
