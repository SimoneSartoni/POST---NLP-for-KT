...
def import_assistments_2009():
    ...
    dataset.set_interactions(problems, real_lens, corrects, 0.2, 0.2)
    return dataset
...
def import_assistments_2012_npz():
    ...
    assistment_dataset = Dataset(name="assistments_2012_npz", path="C:/thesis_2/TransformersForKnowledgeTracing/Knowledge_Tracing/data/assistments/2012_2013/2012-2013-data-with-predictions-4-final.csv.npz")
    assistment_dataset.set_interactions(problems, real_lens, y, 0.2, 0.2)
...
def import_junyi_interactions():
    ...
    junyi_dataset.set_interactions(problems, real_lens, corrects, 0.2, 0.2)
...
def import_poj_interactions():
    ...
    poj_dataset.set_interactions(problems, real_lens, corrects, 0.2, 0.2)
    return poj_dataset
