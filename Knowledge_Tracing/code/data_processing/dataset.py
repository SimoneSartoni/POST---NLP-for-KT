...
class dataset:
    ...
    def set_texts(self, texts, problem_id_to_index, problems_with_text_set, problems_interacted_set, problems_text_and_interacted_set):
        ...
        for p in self.problems:
            ...
            self.real_lens_with_text.append(len(self.problems_with_text_known))
    ...
    def write_dataset_info(self):
        ...
        with open(file, 'w') as f:
            ...
            del [items['path'], items['problems'], items['corrects'], items['real_lens'], items['target_values'],  items['problem_id_to_index'], items['texts'], items['problems_with_text_set'], items['problems_interacted_set'], items['problems_text_and_interacted_set'], items['problems_with_text_known']]
            f.write(str(items))
        file = "C:/Users/Simone Sartoni/Simone/Universita/5anno/thesis_2/TransformersForKnowledgeTracing" \
