...
def process_data_assistments_2009(min_questions=2, max_questions=50,
    ...
    print("loading csv.....")
    if n_rows:
        train_df = pd.read_csv(interactions_filepath, dtype=dtypes, nrows=n_rows, encoding='utf8')
    else:
        train_df = pd.read_csv(interactions_filepath, dtype=dtypes, encoding='utf8')
